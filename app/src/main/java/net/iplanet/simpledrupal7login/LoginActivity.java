    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try
            {
                ...
                session_name = jsonObject.getString(Tokens.KEY_SESSION_NAME_RESPONSE);
                session_id = jsonObject.getString(Tokens.KEY_SESSION_ID_RESPONSE);
                token = jsonObject.getString(Tokens.KEY_TOKEN_RESPONSE);
            }
            catch (Exception ex) {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                try
                {
                    ...
                    intent.putExtra(Tokens.KEY_SESSION_NAME_RESPONSE, session_name);
                    intent.putExtra(Tokens.KEY_SESSION_ID_RESPONSE, session_id);
                    intent.putExtra(Tokens.KEY_TOKEN_RESPONSE, token);
                    intent.putExtra(Tokens.KEY_LOGIN, login);
