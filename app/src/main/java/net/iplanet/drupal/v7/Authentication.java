...
public class Authentication {
    ...
    public HttpResponse doLogin(JSONObject json) throws Exception {
        ...
        return login_DrupalR753(Tokens.serv_end_Pnt_LOGIN, json);
    }
    ...
    public HttpResponse doLogout(String session_name, String session_id, String token) throws Exception {
        ...
        return logout_DrupalR753(endpoint, session_name, session_id, token);
    }

    public HttpResponse login_DrupalR753(String endpoint, JSONObject json) throws Exception  {
    ...
    public HttpResponse logout_DrupalR753(String endpoint, String session_name, String session_id, String token) throws Exception  {
